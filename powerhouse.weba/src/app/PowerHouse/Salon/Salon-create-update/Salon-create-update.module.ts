...
import { SalonCreateUpdateComponent } from './Salon-create-update.component';
...
@NgModule({
  ...
  declarations: [SalonCreateUpdateComponent],
  entryComponents: [SalonCreateUpdateComponent],
  exports: [SalonCreateUpdateComponent]
})
export class SalonCreateUpdateModule {
