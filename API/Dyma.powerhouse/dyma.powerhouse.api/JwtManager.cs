...
using dyma.sit.data.entity;
using dyma.sit.data.views;
                ...
                Subject = new ClaimsIdentity(new[]
                        {
                            ...
                            new Claim(ClaimTypes.NameIdentifier, user.ApellidoMaterno),
                            new Claim(ClaimTypes.Sid, user.NPK_Usuario.ToString()),
                            new Claim(ClaimTypes.PrimarySid, user.NFK_Planta.ToString()),
