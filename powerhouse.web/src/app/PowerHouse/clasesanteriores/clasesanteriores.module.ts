...
import { ClasesAnterioresRoutingModule } from './clasesanteriores-routing.module';
import { ClasesAnterioresComponent } from './clasesanteriores.component';
import { NgbModule } from '@ng-bootstrap/ng-bootstrap';
import { AsistenciaModule } from '../Asistencia/Asistencia.module';
import { CambiarInstructorModule } from '../CambiarInstructor/CambiarInstructor.module';
import { ReservarLugarModule } from '../ReservarLugar/ReservarLugar.module';
@NgModule({
  imports: [
    CommonModule,
    ClasesAnterioresRoutingModule,
    MaterialModule,
  ...
  declarations: [ClasesAnterioresComponent],
  providers: []
})
export class ClasesAnterioresModule {
}
