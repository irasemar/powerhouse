...
import { PaqueteCreateUpdateComponent } from './Paquete-create-update.component';
...
@NgModule({
  ...
  declarations: [PaqueteCreateUpdateComponent],
  entryComponents: [PaqueteCreateUpdateComponent],
  exports: [PaqueteCreateUpdateComponent]
})
export class PaqueteCreateUpdateModule {
