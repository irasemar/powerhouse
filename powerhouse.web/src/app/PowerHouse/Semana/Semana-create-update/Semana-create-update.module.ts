...
import { SemanaCreateUpdateComponent } from './Semana-create-update.component';
...
@NgModule({
  ...
  declarations: [SemanaCreateUpdateComponent],
  entryComponents: [SemanaCreateUpdateComponent],
  exports: [SemanaCreateUpdateComponent]
})
export class SemanaCreateUpdateModule {
