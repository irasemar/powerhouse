...
import { GeneroCreateUpdateComponent } from './Genero-create-update.component';
...
@NgModule({
  ...
  declarations: [GeneroCreateUpdateComponent],
  entryComponents: [GeneroCreateUpdateComponent],
  exports: [GeneroCreateUpdateComponent]
})
export class GeneroCreateUpdateModule {
