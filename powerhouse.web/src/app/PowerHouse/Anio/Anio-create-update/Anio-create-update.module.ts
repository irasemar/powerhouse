...
import { AnioCreateUpdateComponent } from './Anio-create-update.component';
...
@NgModule({
  ...
  declarations: [AnioCreateUpdateComponent],
  entryComponents: [AnioCreateUpdateComponent],
  exports: [AnioCreateUpdateComponent]
})
export class AnioCreateUpdateModule {
