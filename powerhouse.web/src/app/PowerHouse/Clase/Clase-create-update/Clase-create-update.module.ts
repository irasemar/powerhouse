...
import { ClaseCreateUpdateComponent } from './Clase-create-update.component';
...
@NgModule({
  ...
  declarations: [ClaseCreateUpdateComponent],
  entryComponents: [ClaseCreateUpdateComponent],
  exports: [ClaseCreateUpdateComponent]
})
export class ClaseCreateUpdateModule {
